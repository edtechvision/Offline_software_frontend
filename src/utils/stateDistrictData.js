...
export const indianStatesAndDistricts = {
  ...
  "Mizoram": [
    "Aizawl", "Champhai", "Hnahthial", "Khawzawl", "Lawngtlai", "Lunglei", "Mamit", 
  ...
  "Telangana": [
    ...
    "Nalgonda", "Nirmal", "Nizamabad", "Peddapalli", "Rajanna Sircilla", "Rangareddy", 
...
export const getAllStates = () => {
  return Object.keys(indianStatesAndDistricts).sort();
};

// Get districts for a specific state
export const getDistrictsByState = (state) => {
  return indianStatesAndDistricts[state] || [];
};

// Check if a state exists
export const isValidState = (state) => {
  return state in indianStatesAndDistricts;
};

// Check if a district exists in a state
export const isValidDistrict = (state, district) => {
  if (!isValidState(state)) return false;
  return indianStatesAndDistricts[state].includes(district);
};

// Get state by district (useful for validation)
export const getStateByDistrict = (district) => {
  for (const [state, districts] of Object.entries(indianStatesAndDistricts)) {
...
// Common states for quick access (most commonly used)
export const commonStates = [
  "Bihar", "Uttar Pradesh", "West Bengal", "Jharkhand", "Madhya Pradesh", 
  "Rajasthan", "Maharashtra", "Gujarat", "Karnataka", "Tamil Nadu", 
  "Andhra Pradesh", "Telangana", "Kerala", "Punjab", "Haryana", "Delhi"
];

// Common districts for Bihar (most relevant for the application)
export const commonBiharDistricts = [
  "Araria", "Purnia", "Kishanganj", "Katihar", "Madhepura", "Saharsa", 
  "Supaul", "Bhagalpur", "Banka", "Munger", "Lakhisarai", "Sheikhpura", 
  "Nalanda", "Patna", "Bhojpur", "Buxar", "Kaimur", "Rohtas", "Aurangabad", 
  "Gaya", "Jehanabad", "Nawada", "Jamui", "Lakhisarai", "Begusarai", 
  "Khagaria", "Samastipur", "Darbhanga", "Madhubani", "Sitamarhi", 
  "Muzaffarpur", "Vaishali", "Saran", "Siwan", "Gopalganj", "East Champaran", 
  "West Champaran"
];
